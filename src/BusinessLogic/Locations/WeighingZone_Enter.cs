    ...
    public class WeighingZone_Enter : BaseLocation
    {
        ...
        public string BarcodeToScale
        {
            ...
            set
            {
                ...
                Log(string.IsNullOrEmpty(value) ? "To-scale barcode cleared" : $"To-Scale barcode set to {value}");
            }
        }
        ...
        public string BarcodeOnScale
        {
            ...
            set
            {
                ...
                Log(string.IsNullOrEmpty(value) ? "On-scale barcode cleared" : $"On-Scale barcode set to {value}");
                Evaluate();
            }
        }
        ...
        protected override void InitScripts()
        {
            ...
            var name = $"Dispatch from CSD to scale (Loc:{LocId}) ";
            ...
            {
                return MakeConditionalStatement($"Rebound CSD:{csdNum} Dispatch", OUTPUT_ENFORCEMENT.ENF_UNTIL_CONDITION_TRUE).AddTimeoutCondition(TIMEOUT_RANGE.TR_100MS, 2)
        ...
        protected override void RequestWmsDirection(string barcode)
        {
            ...
            Log($"Weighing barcode preset: {barcode}");
        }
