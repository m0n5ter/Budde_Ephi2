...
// Type: PharmaProject.Wms_Communication.WmsCommunicator
...
namespace PharmaProject.Wms_Communication
{
    public static class WmsCommunicator
    {
        ...
        {
            Console.WriteLine("{0}, WMS Connection {1}", DateTime.Now.TimeOfDay, rfc1006Server.Status);
            if (rfc1006Server.Status != Rfc1006Status.Disconnected)
                return;
