...
// Type: Ephi.Core.UTC.ConditionalStatements.CONDITIONAL_STATE
...
public enum CONDITIONAL_STATE : byte
{
    ERROR = 16, // 0x10
    VALID = 17, // 0x11
    RUNNING = 18, // 0x12
    ...
    TIMED_OUT = 22, // 0x16
    DELETED = 23, // 0x17
    UNDER_CONSTRUCTION = 24, // 0x18
    READY_FOR_UPLOAD = 25, // 0x19
    VALIDATION_PENDING = 26, // 0x1A
    RUN_REQUESTED = 27, // 0x1B
    DELETE_REQUESTED = 28, // 0x1C
    CANCEL_REQUESTED = 29 // 0x1D
}